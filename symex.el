...
(defun symex-set-orientation ()
  ...
  (cond ((eq 'squirrel symex-orientation)
         ...
         (define-key evil-symex-state-map (kbd "M-j") 'symex-goto-lowest))
        ((eq 'inverted symex-orientation)
         (define-key evil-symex-state-map (kbd "k") 'symex-go-down)
         (define-key evil-symex-state-map (kbd "j") 'symex-go-up)
         (define-key evil-symex-state-map (kbd "C-j") 'symex-descend-branch)
         (define-key evil-symex-state-map (kbd "C-k") 'symex-climb-branch)
         (define-key evil-symex-state-map (kbd "M-k") 'symex-goto-lowest)
         (define-key evil-symex-state-map (kbd "M-j") 'symex-goto-highest))
